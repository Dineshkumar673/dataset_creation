...
char_dir = "/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset_ver_2/Dataset/segmented_dataset/Arya_black_chudi_dataset_0001/"
...
dest_dir = "/mnt/fs/missing_images_ver_2/Arya_black_chudi_0001/"
...
for aug_dir in char_dir_lst:
  ...
  for sign_dir in aug_dir_lst:
    ...
    for image in sign_dir_lst:
      ...
      if (hand_lndmarkdict_left[k]['None_pose'] == 0) and (hand_lndmarkdict_left[k+1]['None_pose'] == 0)   and (hand_lndmarkdict_left[k-1]['None_pose'] == 0) or (hand_lndmarkdict_right[k]['None_pose'] == 0) and (hand_lndmarkdict_right[k+1]['None_pose'] == 0) and (hand_lndmarkdict_right[k-1]['None_pose'] == 0):
    ...
    result.to_csv('/mnt/fs/dataset_creation/Arya_black_chudi_0001.csv', mode='a', header=False)
print("Done with Arya_black_chudi_0001")
